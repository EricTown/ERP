...
<head>
    <meta charset="UTF-8">
    <title>首页</title>
    <link rel="stylesheet" type="text/css" href="/APP/Public/css/default.css">
    <link rel="stylesheet" type="text/css" href="/APP/Public/easyui/themes/default/easyui.css">
    <link rel="stylesheet"  type="text/css" href="/APP/Public/easyui/themes/icon.css">
    <script type="text/javascript" src="/APP/Public/easyui/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="/APP/Public/easyui/jquery.easyui.js"></script>
    <script type="text/javascript" src="/APP/Public/easyui/outlook2.js"></script>
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        background: url(/APP/Public/img/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体">
    <span style="float:right; padding-right:20px;" class="head">欢迎 Eric <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
    <span style="padding-left:10px; font-size: 16px; "><img src="/APP/Public/img/blocks.gif" width="20" height="20" align="absmiddle" /> </span>
</div>
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
    <div class="footer">by Eric</div>
</div>
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
    <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
        <div title="欢迎使用" style="padding:20px;overflow:hidden;" id="home" href="<?php echo U('Index/gsys');?>">
